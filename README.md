# Jetsnack — design artifacts

Importable sticker-sheet for **`custom design system (JetsnackTheme)`**, rendered from the committed
...
**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetsnack/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetsnack/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/jetsnack/)**

The same rendered components, served live by `compose-preview serve --catalogs jetsnack` —
...
| --- | --- |
| Components | **34** |
| Rendered images (PNG) | **153** |
| Editable wireframes (SVG) | **34** |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetsnack/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetsnack/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/jetsnack/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
