...
**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetchat/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetchat/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/jetchat/)**

The same rendered components, served live by `compose-preview serve --catalogs jetchat` —
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetchat/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetchat/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/jetchat/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
