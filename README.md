# JetNews — design artifacts

Importable sticker-sheet for **`androidx.compose.material3:material3`**, rendered from the committed
`@Preview` catalog in [`yschimke/compose-samples`](https://github.com/yschimke/compose-samples). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetnews/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetnews/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/jetnews/)**

The same rendered components, served live by `compose-preview serve --catalogs jetnews` —
...
| --- | --- |
| Components | **15** |
| Rendered images (PNG) | **89** |
| Editable wireframes (SVG) | **15** |
| Editable design vectors (figma-svg) | **15** |
| Components with a11y greenlines | **8** |
| Library | `androidx.compose.material3:material3`<br>`androidx.compose.material3.adaptive:adaptive`<br>`androidx.navigation3:navigation3` |
| Renderer | compose-preview 0.19.61 |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetnews/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-samples/blob/design-artifacts/jetnews/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/jetnews/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/yschimke/compose-samples/actions/workflows/design-artifacts.yml)
