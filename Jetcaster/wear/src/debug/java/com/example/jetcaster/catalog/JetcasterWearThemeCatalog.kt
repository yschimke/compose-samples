...
/**
 * The dark Wear Material 3 theme shipped by Jetcaster.
 *
 * Wear and phone Material 3 use different theme locals and token roles, so this
 * deliberately uses [WearThemeCatalog] rather than the phone-only ThemeCatalog.
 */
